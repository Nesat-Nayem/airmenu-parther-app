...
class VendorDashboardTabletView extends StatelessWidget {
  const VendorDashboardTabletView({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _VendorDashboardTabletContent(),
    );
  }
}

class _VendorDashboardTabletContent extends StatelessWidget {
  const _VendorDashboardTabletContent();
