...
class CategoryTabletView extends StatefulWidget {
  final List<CategoryEntity> categories;

  const CategoryTabletView({super.key, required this.categories});

  @override
  State<CategoryTabletView> createState() => _CategoryTabletViewState();
}

class _CategoryTabletViewState extends State<CategoryTabletView> {
