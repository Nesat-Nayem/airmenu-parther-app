...
class GeneratePrivacyPolicyUsecase
    implements UseCaseOneInput<String, PrivacyPolicyModel> {
  final PrivacyPolicyRepository repository;

  GeneratePrivacyPolicyUsecase(this.repository);

  @override
  Future<Either<Failure, PrivacyPolicyModel>> invoke(
    String platformName,
  ) async {
    return await repository.generatePrivacyPolicy(platformName);
  }
}
