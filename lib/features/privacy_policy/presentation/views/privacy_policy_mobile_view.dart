...
class PrivacyPolicyMobileView extends StatefulWidget {
  final String content;

  const PrivacyPolicyMobileView({super.key, required this.content});

  @override
  State<PrivacyPolicyMobileView> createState() =>
      _PrivacyPolicyMobileViewState();
}

class _PrivacyPolicyMobileViewState extends State<PrivacyPolicyMobileView> {
  ...
  @override
  void didUpdateWidget(PrivacyPolicyMobileView oldWidget) {
