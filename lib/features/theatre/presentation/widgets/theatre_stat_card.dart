...
class TheatreStatCard extends StatefulWidget {
  final TheatreStat stat;

  const TheatreStatCard({super.key, required this.stat});

  @override
  State<TheatreStatCard> createState() => _TheatreStatCardState();
}

class _TheatreStatCardState extends State<TheatreStatCard> {
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.stat.subtext.isNotEmpty)
              Text(
                widget.stat.subtext,
