...
class UpdateHelpSupportUsecase
    implements UseCaseOneInput<String, HelpSupportModel> {
  final HelpSupportRepository repository;
  UpdateHelpSupportUsecase(this.repository);
  @override
  Future<Either<Failure, HelpSupportModel>> invoke(String content) async =>
      await repository.updateHelpSupport(content);
}
